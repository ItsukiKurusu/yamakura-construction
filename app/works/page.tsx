...
import { FadeIn, StaggerContainer, StaggerItem } from "@/components/motion-utils"
...
export default function WorksPage() {
  ...
  const works = [
    ...
    },
    {
      ...
      period: "2025年〜",
      location: "滋賀県大津市",
      description: "地域住民の交流拠点となる市民会館を新築。宮大工の伝統技術を活かした本格的な施工を行っています。",
      details: "市民会館新築工事",
      features: ["公共施設", "地域貢献", "新築工事", "伝統工法"],
      categoryColor: "bg-blue-100 text-blue-800",
    },
  ]
          ...
          <div className="flex flex-wrap gap-3">
            {categories.map((category) => (
              <Button
                ...
                size="sm"
                className={`transition-all duration-200 ${selectedCategory === category ? "bg-black hover:bg-gray-800" : "hover:bg-gray-50"}`}
